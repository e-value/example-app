...
Route::get('sample/', [App\Http\Controllers\SampleController::class, 'show']);
Route::get('/tweet', \App\Http\Controllers\Tweet\IndexController::class) ->name('tweet.index');

Route::middleware('auth')->group(function(){
    Route::get('/tweet/{tweetId}', \App\Http\Controllers\Tweet\ShowController::class)->name('tweet.show')->where('tweetId', '[0-9]+');
